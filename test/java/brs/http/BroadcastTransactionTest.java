...
public class BroadcastTransactionTest {
  ...
  @Test
  public void processRequest_validationException() throws EsgException {
    final String mockTransactionBytesParameter = "mockTransactionBytesParameter";
    final String mockTransactionJson = "mockTransactionJson";
    ...
    Mockito.doThrow(EsgException.NotCurrentlyValidException.class).when(transactionServiceMock).validate(eq(mockTransaction));
