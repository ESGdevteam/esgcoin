...
abstract class CreateTransaction extends APIServlet.JsonRequestHandler {
  ...
  final JsonElement createTransaction(HttpServletRequest req, Account senderAccount, Long recipientId, long amountNQT, Attachment attachment) throws EsgException {
  ...
  private long minimumFeeNQT() {
    return Esg.getFluxCapacitor().getValue(FluxValues.PRE_DYMAXION) ? FEE_QUANT : ONE_ESG;
  }
