...
public final class DigitalGoodsStore {
  ...
  public static class Goods {
    ...
    private static AmzKey.LongKeyFactory<Goods> goodsDbKeyFactory() {
      return Amz.getStores().getDigitalGoodsStoreStore().getGoodsDbKeyFactory();
    }

    private static VersionedEntityTable<Goods> goodsTable() {
      return Amz.getStores().getDigitalGoodsStoreStore().getGoodsTable();
    }
    ...
    protected Goods(long id, AmzKey dbKey, long sellerId, String name, String description, String tags, int timestamp,
    ...
    public Goods(AmzKey dbKey, Transaction transaction, Attachment.DigitalGoodsListing attachment) {
      this.dbKey = dbKey;
  ...
  public static class Purchase {
    ...
    private static AmzKey.LongKeyFactory<Purchase> purchaseDbKeyFactory() {
      return Amz.getStores().getDigitalGoodsStoreStore().getPurchaseDbKeyFactory();
    }

    private static AmzKey.LongKeyFactory<Purchase> feedbackDbKeyFactory() {
      return Amz.getStores().getDigitalGoodsStoreStore().getFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, EncryptedData> feedbackTable() {
      return Amz.getStores().getDigitalGoodsStoreStore().getFeedbackTable();
    }

    private static AmzKey.LongKeyFactory<Purchase> publicFeedbackDbKeyFactory() {
      return Amz.getStores().getDigitalGoodsStoreStore().getPublicFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, String> publicFeedbackTable() {
      return Amz.getStores().getDigitalGoodsStoreStore().getPublicFeedbackTable();
    }
    ...
    protected Purchase(long id, AmzKey dbKey, long buyerId, long goodsId, long sellerId, int quantity,
