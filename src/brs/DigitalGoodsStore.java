...
public final class DigitalGoodsStore {
  ...
  public static class Goods {
    ...
    private static EsgKey.LongKeyFactory<Goods> goodsDbKeyFactory() {
      return Esg.getStores().getDigitalGoodsStoreStore().getGoodsDbKeyFactory();
    }

    private static VersionedEntityTable<Goods> goodsTable() {
      return Esg.getStores().getDigitalGoodsStoreStore().getGoodsTable();
    }
    ...
    protected Goods(long id, EsgKey dbKey, long sellerId, String name, String description, String tags, int timestamp,
    ...
    public Goods(EsgKey dbKey, Transaction transaction, Attachment.DigitalGoodsListing attachment) {
      this.dbKey = dbKey;
  ...
  public static class Purchase {
    ...
    private static EsgKey.LongKeyFactory<Purchase> purchaseDbKeyFactory() {
      return Esg.getStores().getDigitalGoodsStoreStore().getPurchaseDbKeyFactory();
    }

    private static EsgKey.LongKeyFactory<Purchase> feedbackDbKeyFactory() {
      return Esg.getStores().getDigitalGoodsStoreStore().getFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, EncryptedData> feedbackTable() {
      return Esg.getStores().getDigitalGoodsStoreStore().getFeedbackTable();
    }

    private static EsgKey.LongKeyFactory<Purchase> publicFeedbackDbKeyFactory() {
      return Esg.getStores().getDigitalGoodsStoreStore().getPublicFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, String> publicFeedbackTable() {
      return Esg.getStores().getDigitalGoodsStoreStore().getPublicFeedbackTable();
    }
    ...
    protected Purchase(long id, EsgKey dbKey, long buyerId, long goodsId, long sellerId, int quantity,
