...
public enum HistoricalMoments {
    ...
    DIGITAL_GOODS_STORE_BLOCK(0, 0, Props.DEV_DIGITAL_GOODS_STORE_BLOCK_HEIGHT),
    AUTOMATED_TRANSACTION_BLOCK(0, 0, Props.DEV_AUTOMATED_TRANSACTION_BLOCK_HEIGHT),
    AT_FIX_BLOCK_2(0, 0, Props.DEV_AT_FIX_BLOCK_2_BLOCK_HEIGHT),
    AT_FIX_BLOCK_3(0, 0, Props.DEV_AT_FIX_BLOCK_3_BLOCK_HEIGHT),
    AT_FIX_BLOCK_4(0, 0, Props.DEV_AT_FIX_BLOCK_4_BLOCK_HEIGHT),
